     ...
     <View style={styles.headContiner}> 
      <View style={styles.Maincontainer}>
        ...
        <View style = { styles.mainView }>
          <TouchableOpacity 
          onPress = {()=>{ this.props.navigation.navigate('VerificationForm') }}
      ...
      <View style={styles.Maincontainer}>
        ...
        <View style = { styles.mainView}>
          <TouchableOpacity 
          onPress = {()=>{ this.props.navigation.navigate('ProvidedCompany') }}
          style = { styles.cardView}>
          ...
          <TouchableOpacity 
          onPress = {()=>{ this.props.navigation.navigate('OfferLatter') }}
          style = { styles.cardView }>
